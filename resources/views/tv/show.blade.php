...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ 'https://image.tmdb.org/t/p/w500' . $show['poster_path']}}" alt="parasite" class="w-64lg:w-96">
            </div>
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-2xl mt-4">
                    <span class="ml-1">Seasons : {{$show['number_of_seasons']}}</span>
                </div>
                <div class="flex flex-wrap items-center text-gray-400 text-2xl mt-4">
                    <span class="ml-1">Episodes : {{$show['number_of_episodes']}}</span>
                </div>

                <div class="flex flex-wrap items-center text-gray-400 text-2xl mt-4">
                    <span class="ml-1">Status : {{$show['status']}}</span>
                </div>

                <div class="mt-12">
                    <a href="https://www.youtube.com/watch?v={{$show['videos']['results'][0]['key']}}" target="_blank">
